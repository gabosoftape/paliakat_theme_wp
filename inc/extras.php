...
function shapely_search_form( $form ) {
    ...
    <label class="screen-reader-text" for="s">' . esc_html__( 'Buscar Para:', 'shapely' ) . '</label>
    <input type="text" placeholder="' . esc_html__( 'Escribe Aqui...', 'shapely' ) . '" value="' . esc_attr( get_search_query() ) . '" name="s" id="s" />
    <button type="submit" class="searchsubmit"><i class="fa fa-search" aria-hidden="true"></i><span class="screen-reader-text">' . esc_attr__( 'Buscar', 'shapely' ) . '</span></button>
    </form>';
